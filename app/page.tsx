  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      dropdowns.forEach(dropdown => {
        if (!dropdown.contains(event.target as Node) && !dropdown.previousElementSibling?.contains(event.target as Node)) {
              ...
              {filteredMatches.map((match) => (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mt-4 pt-4 border-t border-[#2d3436]/50 group-hover:border-[#6c5ce7]/30 transition-colors">
                      <div className="relative">
                        ...
                        {/* Dropdown Menu */}
                        <div className="hidden absolute top-full left-0 right-0 mt-2 bg-[#2d3436] border border-[#636e72]/50 rounded-lg shadow-xl z-50 overflow-hidden">
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                            ...
                            className="w-full px-4 py-3 text-left text-white hover:bg-[#636e72]/30 transition-colors flex items-center"
                          >
                          ...
                          <button
                            onClick={(e) => {
                              e.stopPropagation();
                              const calendarEvent = createCalendarEvent(match);
                              downloadICSFile(calendarEvent.ics, `koi-match-${match.id}.ics`);
                              (e.currentTarget.parentElement as HTMLElement).classList.add('hidden');
                            }}
                            className="w-full px-4 py-3 text-left text-white hover:bg-[#636e72]/30 transition-colors flex items-center"
                          >
